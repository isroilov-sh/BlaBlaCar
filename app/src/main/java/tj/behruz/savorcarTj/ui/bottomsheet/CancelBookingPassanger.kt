...
import tj.behruz.savorcarTj.databinding.CancelBookingFragmentBinding
...
class CancelBookingPassenger(val handler: (EditModel) -> Unit, private val bid: Int, val number: Int, val tripId: Int): BottomSheetDialogFragment() {

    private lateinit var binding: CancelBookingFragmentBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        val dataBinding = DataBindingUtil.inflate<CancelBookingFragmentBinding>(inflater, R.layout.cancel_booking_fragment, container, false)
    ...
    private fun init() {
        ...
        binding.cancelButton.setOnClickListener {
            progressDialog.show()
            viewModel.cancelBookingPassenger(userId = prefrence.userId, hash = prefrence.hashbyId.toString(), tripId = tripId, bookingId = bid, count = number).observe(viewLifecycleOwner, Observer {
